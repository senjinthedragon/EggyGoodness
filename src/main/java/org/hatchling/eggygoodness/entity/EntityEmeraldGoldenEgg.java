...
public class EntityEmeraldGoldenEgg extends EntityThrowable
{
    public EntityEmeraldGoldenEgg(World p_i1779_1_)
    {
        super(p_i1779_1_);
    }
    public EntityEmeraldGoldenEgg(World p_i1780_1_, EntityLivingBase p_i1780_2_)
    {
        super(p_i1780_1_, p_i1780_2_);
    }
    public EntityEmeraldGoldenEgg(World p_i1781_1_, double p_i1781_2_, double p_i1781_4_, double p_i1781_6_)
    {
