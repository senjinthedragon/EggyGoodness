...
public class EntityGoldenChicken extends EntityAnimal
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote && !this.isChild() && !this.func_152116_bZ() && --this.timeUntilNextEgg <= 0)
        {
            ...
            this.dropItem(ModItems.goldenEgg, 1);
            this.timeUntilNextEgg = this.rand.nextInt(6000) + 6000;
        }
    }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (int k = 0; k < j; ++k)
        {
            this.dropItem(ModItems.goldenFeather, 1);
        }
    ...
    public EntityGoldenChicken createChild(EntityAgeable p_90011_1_) {
