...
public class Reference
{
    ...
    public static final String GUI_FACTORY_CLASS = "org.hatchling.eggygoodness.client.gui.GuiFactory";

    public static boolean CONFIG_OVERWRITE_VANILLA_RECIPES = true;
}
