...
import org.hatchling.eggygoodness.items.ItemFoodBowl;
...
public class EggyGoodness
{
    ...
    {
        Reference.rawEgg = (ItemFood) new ItemFood(1, 0.2f, true).setUnlocalizedName("rawEgg").setTextureName("eggygoodness:rawEgg");
        Reference.bakedEgg = (ItemFood) new ItemFood(3, 0.6f, true).setUnlocalizedName("bakedEgg").setTextureName("eggygoodness:bakedEgg");
        ...
        Reference.softBoiledEgg = (ItemFood) new ItemFood(3, 0.6f, true).setUnlocalizedName("softBoiledEgg").setTextureName("eggygoodness:boiledEgg");
        ...
        Reference.hardBoiledEgg = (ItemFood) new ItemFood(5, 0.6f, true).setUnlocalizedName("hardBoiledEgg").setTextureName("eggygoodness:boiledEgg");
        Reference.rawScrambledEgg = (ItemFoodBowl) new ItemFoodBowl(2).setUnlocalizedName("rawScrambledEgg").setTextureName("eggygoodness:rawScrambledEgg");
        Reference.scrambledEgg = (ItemFoodBowl) new ItemFoodBowl(5).setUnlocalizedName("scrambledEgg").setTextureName("eggygoodness:scrambledEgg");
    }
