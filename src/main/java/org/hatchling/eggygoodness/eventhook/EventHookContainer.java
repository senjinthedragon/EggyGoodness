...
public class EventHookContainer
{
    ...
    public void playerInteractEvent(PlayerInteractEvent event)
    {
        ...
        {
            if(player.getCurrentEquippedItem().getItem() == Items.egg || player.getCurrentEquippedItem().getItem() == ModItems.unpeeledSoftBoiledEgg || player.getCurrentEquippedItem().getItem() == ModItems.unpeeledHardBoiledEgg)
            {
